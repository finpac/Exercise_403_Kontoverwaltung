...
public class AccountGUI extends javax.swing.JFrame {
    ...
    private UserListModel usr;
    private Account acc;
    
    public AccountGUI() {
        initComponents();
        usr = new UserListModel();
        acc = new Account();
        liUser.setModel(usr);
    }
    ...
    private void onAccountTest(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onAccountTest
        ...
        catch(EmptyException ee)
        {
            if(usr.getSize() == 0)
            {
                JOptionPane.showMessageDialog(this, "Sie müssen zuerst Benutzer hinzufügen", "Keine Benutzer", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void onCreateAccount(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onCreateAccount
        ...
        acc.setMoney(startMoney);
        acc.output();
        lbMoney.setText(acc.getMoney() + " Euro");
